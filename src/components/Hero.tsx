          ...
          <div className="lg:pl-10 flex justify-center">
            <div className="relative w-full max-w-[500px]">
              ...
              <img 
                ...
                alt="Farmer using smart technology in field" 
                className="relative z-10 rounded-lg shadow-2xl border-4 border-white w-full h-auto object-cover animate-float"
                onError={(e) => {
                  // Fallback to placeholder if image fails to load
                  e.currentTarget.src = "https://images.unsplash.com/photo-1625246333195-78d9c38ad449?q=80&w=1000&auto=format&fit=crop";
                  // Second fallback
